...
<div class="modal fade" id="exampleModalc" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">New Add</h1>
  ...
  <input  name="price" type="text" class="form-control" placeholder="price" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
  <input  name="desc" type="text" class="form-control" placeholder="description" aria-label="Recipient's username" aria-describedby="basic-addon2" required>
  <h6>FROM</h6>
  ...
  <h6>TO</h6>
  <input  name="datefinal" type="datetime-local"  class="form-control"  aria-label="Recipient's username" aria-describedby="basic-addon2"required >
